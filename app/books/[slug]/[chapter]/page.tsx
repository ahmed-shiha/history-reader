  ...
  return (
    ...
    >
      <MDXRemote
        ...
        options={{
          mdxOptions: {
            format: ['ai-concepts', 'physics-concepts', 'arabic-concepts', 'arabic-spiral', 'euphemisms-kilito', 'brain-kilito', 'mockingbird-kilito', 'kilito-ai', 'maqalat', 'balagha-wadiha', 'production-ai', 'shatharat-fawaid', 'ai-engineering-huyen'].includes(params.slug) ? 'md' : 'mdx',
