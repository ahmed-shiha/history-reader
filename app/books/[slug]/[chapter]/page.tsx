  ...
  return (
    ...
    >
      <MDXRemote
        ...
        options={{
          mdxOptions: {
            format: ['ai-concepts', 'physics-concepts', 'arabic-concepts', 'arabic-spiral', 'euphemisms-kilito', 'brain-kilito', 'mockingbird-kilito', 'kilito-ai', 'maqalat'].includes(params.slug) ? 'md' : 'mdx',
